...
SELECT AOLDATA.LOCATION.ZIP,FBI_TMP.CITY, FBI_TMP.PROPERTY_CRIME, FBI_TMP.VIOLENT_CRIME
FROM AOLDATA.LOCATION,FBI_TMP
WHERE AOLDATA.LOCATION.CITY = FBI_TMP.CITY
ORDER BY AOLDATA.LOCATION.ZIP;


SELECT * FROM FBI_TMP ORDER BY FBI_TMP.CITY;
