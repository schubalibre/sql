...
/* Wir kreieren eine VIEW um uebersichtlicher und schneller arbeiten zu koennen */
...
SELECT AOLDATA.QUERYDATA_IDX.ANONID, LOCATION.ID 
FROM AOLDATA.QUERYDATA_IDX,LOCATION 
WHERE 
CONTAINS(AOLDATA.QUERYDATA_IDX.QUERY, LOWER(LOCATION.CITY), 1) > 0
